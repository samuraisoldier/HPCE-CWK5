#ifndef user_integral_hpp_v31
#define user_integral_hpp_v31
  ...
  IntegralProvidervrep()
  {
			  ...
			  ) const
    {
	  ...
	  pOutput->value=total;
		...
		ReferenceExecute(log, pInput, pOutput);
		log->LogInfo("hello ref");
